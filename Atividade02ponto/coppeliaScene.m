...
pos = obj.sim.getObjectPosition(obj.robot,-1); z = pos{3};
pose0 = block.DialogPrm(1).Data;

obj.sim.setObjectOrientation(obj.robot,-1,[0,0,pose0(3)]);
obj.sim.setObjectPosition(obj.robot,-1,[pose0(1),pose0(2),z]);
